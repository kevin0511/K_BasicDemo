...
#ifndef K_DefaultHeader_h
#define K_DefaultHeader_h


typedef NS_ENUM (NSUInteger, BDHomeAttentionListType){
    
    /** 推荐的关注列表*/
    BDHomeAttentionListTypeRecommend,
    /** 当前用户的关注用户列表*/
    BDHomeAttentionListTypeNormal
};
