...
#import "MBProgressHUD+BDAddition.h"

@implementation MBProgressHUD (BDAddition)
...
{
    [self showSuccess:nil toView:view];
}
...
+ (void)showMessage:(NSString *)message toView:(UIView *)view
{
    ...
    hud.margin = 10.f;
    //设置hud颜色
    hud.color = kRGBAColor(0.41f, 0.46f, 0.50f, 0.600f);
