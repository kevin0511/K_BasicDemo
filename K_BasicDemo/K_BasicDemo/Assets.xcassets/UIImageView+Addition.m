...
+ (UIImageView *)imageViewWithAnimationedGIFImageSource:(CGImageSourceRef) source
...
+ (UIImageView *)imageViewWithGIFData:(NSData *)data
{
    ...
    UIImageView * imageView = [UIImageView imageViewWithAnimationedGIFImageSource:source andDuration:duration];
    CFRelease(source);
    return imageView;
}
